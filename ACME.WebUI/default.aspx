...
<form id="form1" runat="server">
                ...
                <div class="input-group">
                    <label class="input-group-btn">
                        <span class="btn btn-primary">
                            Browse...<asp:FileUpload ID="LoadFileUpload" CssClass="form-control LoadFile" accept=".txt" style="display: none;" runat="server"/>
                        </span>
                    </label>
    ...
    <script>
        $('body', 'html').on('change', '.LoadFile', function() {
             $('#FileNameText').val($(this).val().replace(/\\/g, '/').replace(/.*\//, ''));
        });
        $('body', 'html').on('click', '#FileNameText', function() {
